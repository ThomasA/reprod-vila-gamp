...
if 1
  if newEM
    ...
    optGAMP.uniformVariance = false; % speeds things up
  end
end
...
%if DEMO==1
  save vila2011_results_old_not_unif successes* rho_values delta_values reps
%end
...
if min(grid_size)>1
  figure(3); clf;
  regression_plot('vila2011_results_old_not_unif', ...
                  'Simulated phase transition (old alg., unif. option false)');
end
